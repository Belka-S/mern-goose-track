import{P as x,i as h,u as g,j as e,w as f,s as o,t as s,x as j,y as b,M as v,A as w,m as y,K as k}from"./index-2796746f.js";import{C as S,T as $,e as F,F as C,I as A,A as P,B as T,b as B}from"./AuthNavigate-cd9264e1.js";import{l,a as E,b as R}from"./rocket3x-304f4dc1.js";function d({onSubmitForm:n}){const[a,t]=h.useState(!1),{t:i}=g();return e.jsxs(S,{children:[e.jsx($,{children:i("Forgot Password")}),e.jsx(f,{validationSchema:F,initialValues:{email:""},validateOnBlur:!1,validateOnChange:a,validateOnMount:!1,onSubmit:async r=>{t(!0),n(r),t(!1)},children:r=>{const{errors:c,handleSubmit:m,submitCount:p,values:u}=r;return e.jsxs(C,{autoComplete:"off",children:[e.jsx(A,{children:e.jsx(P,{name:"email",title:"Email",type:"email",placeholder:"nadiia@gmail.com",id:"pwd_email",validateAfterSubmit:a,submitCount:p,errors:c,setValidateAfterSubmit:t,values:u.email})}),e.jsx(T,{type:"submit",onClick:m,children:i("Reset Password")})]})}})]})}d.propTypes={onSubmitForm:x.func.isRequired};const I=o.div`
  height: 100vh;
  width: 100vw;
