import{O as p,Q as a,U as e,V as I,s,t,j as i,W as T,Y as A,P as o,Z as C,u as g,H as L,_ as W,i as x,$ as F,a0 as N,a1 as B,E as O,N as H,r as $}from"./index-fbcf4031.js";const et=p().shape({name:a().min(4,e.t("Too Short")).max(20,e.t("Too Long")).matches(/^[a-zA-Z0-9_]*$/,e.t("Only letters")).required(e.t("Name Required")),email:a().required(e.t("Email Required")).email(e.t("Invalid Email")),password:a().required(e.t("Password Required")).min(6,e.t("Password Characters"))}),it=p().shape({email:a().required(e.t("Email Required")).email(e.t("Invalid Email")),password:a().required(e.t("Password Required")).min(6,e.t("Password Characters"))}),st=p().shape({email:a().required(e.t("Email Required")).email(e.t("Invalid Email"))}),ot=p().shape({newPassword:a().required(e.t("Password Required")).min(6,e.t("Password Characters")),confirmPassword:a().required(e.t("Password Required")).min(6,e.t("Password Characters")).oneOf([I("newPassword")],e.t("Must Match"))}),M=s.img`
  position: absolute;
  right: 46px;
  bottom: 11px;
  width: 24px;
