...
`;function J(){const l=b(),a=y(),s=v(),[c,o]=x.useState(!1),i=()=>{o(!1)},p=t=>{l(E(t)),o(!0)},r=t=>{l($(t))};return e.jsxs(W,{children:[e.jsxs(z,{children:[e.jsxs(U,{children:[e.jsx("source",{media:"(min-width: 1440px)",srcSet:`${u} 1x, ${O} 2x, ${P} 3x`}),e.jsx("img",{src:u,alt:"Logo goose"})]}),e.jsxs(G,{children:[e.jsx(g,{callBack:p}),e.jsx(q,{formType:"register"})]})]}),c&&e.jsxs(k,{onClose:i,color:w.black,children:[a?e.jsx(S,{}):e.jsx(B,{onSubmitForm:r}),s&&i()]})]})}export{J as default};
