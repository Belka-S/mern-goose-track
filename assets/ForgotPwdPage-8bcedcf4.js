import{P as x,k as h,u as g,j as e,x as f,s as o,t as s,y as j,z as b,M as v,B as y,n as w,O as k}from"./index-b0910c9a.js";import{C as S,T as $,e as F,F as C,I as P,A,B,b as T}from"./AuthNavigate-db011a1c.js";import{l,a as E,b as R}from"./rocket3x-cffb2115.js";import"./eye-off-fd98a0c4.js";function d({onSubmitForm:n}){const[a,t]=h.useState(!1),{t:i}=g();return e.jsxs(S,{children:[e.jsx($,{children:i("Forgot Password")}),e.jsx(f,{validationSchema:F,initialValues:{email:""},validateOnBlur:!1,validateOnChange:a,validateOnMount:!1,onSubmit:async r=>{t(!0),n(r),t(!1)},children:r=>{const{errors:c,handleSubmit:m,submitCount:p,values:u}=r;return e.jsxs(C,{autoComplete:"off",children:[e.jsx(P,{children:e.jsx(A,{name:"email",title:"Email",type:"email",placeholder:"nadiia@gmail.com",id:"pwd_email",validateAfterSubmit:a,submitCount:p,errors:c,setValidateAfterSubmit:t,values:u.email})}),e.jsx(B,{type:"submit",onClick:m,children:i("Reset Password")})]})}})]})}d.propTypes={onSubmitForm:x.func.isRequired};const I=o.div`
  height: 100vh;
  width: 100vw;
