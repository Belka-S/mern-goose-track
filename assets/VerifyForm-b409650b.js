...
`,{DEV:g,VITE_BACK_URL_DEV:u,VITE_BACK_URL_PROD:b}={VITE_BACK_URL_PROD:"https://belka-s-mern-goose-track.onrender.com",BASE_URL:"/mern-goose-track/",MODE:"production",DEV:!1,PROD:!0,SSR:!1},$=g?u:b,a=({title:e})=>{const{t:i}=s();return o.jsxs(h,{href:`${$}/api/users/google`,children:[o.jsx(m,{width:"24px",height:"24px"}),i(e)]})};a.propTypes={title:r.string};const F=a,w=n.div`
  display: flex;
  width: 100%;
