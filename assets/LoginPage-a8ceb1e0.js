import{i as h,u as j,j as s,w as b,P as y,s as c,t as i,x as v,y as w,z as S,M as p,A as u,m as k,B as L,C as A}from"./index-76e3b134.js";import{i as C,A as $,V as F}from"./VerifyForm-fbe62d72.js";import{C as I,T as B,v as V,F as E,I as T,A as x,B as M,a as O,b as P}from"./AuthNavigate-544b9c23.js";import{l as g,a as R,b as W}from"./rocket3x-cffb2115.js";function f({onSubmitForm:n}){const[t,e]=h.useState(!1),{t:r}=j();return s.jsxs(I,{children:[s.jsx(B,{children:r("Log In")}),s.jsx(b,{validationSchema:V,initialValues:{email:"",password:""},validateOnBlur:!1,validateOnChange:t,validateOnMount:!1,onSubmit:async o=>{e(!0),n(o),e(!1)},children:o=>{const{errors:l,handleSubmit:d,submitCount:a,values:m}=o;return s.jsxs(E,{autoComplete:"off",children:[s.jsxs(T,{children:[s.jsx(x,{name:"email",title:"Email",type:"email",placeholder:"nadiia@gmail.com",id:"login_email",validateAfterSubmit:t,submitCount:a,errors:l,setValidateAfterSubmit:e,values:m.email}),s.jsx(x,{name:"password",title:"Password",type:"password",placeholder:"●●●●●●●",id:"login_password",validateAfterSubmit:t,submitCount:a,errors:l,setValidateAfterSubmit:e,values:m.password})]}),s.jsxs(M,{type:"submit",onClick:d,children:[r("Log in"),s.jsx(O,{src:C,alt:"LogIn SVG"})]})]})}}),s.jsx($,{title:"Log In With Google"})]})}f.propTypes={onSubmitForm:y.func.isRequired};const z=c.div`
  height: 100vh;
  width: 100vw;
