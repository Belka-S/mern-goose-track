...
`,Tr=g(ut)`
  ...
  height: 24px;
  color: white;
`,Cr=Bt().shape({title:de().max(250,"Title is too long").required("Title is required"),start:de().required("Start time is required"),end:de().required("End time is required").test("is-greater","End time should be greater than start time",function(e){const{start:r}=this.parent;if(r&&e){const i=pe(r,"HH:mm",new Date);return pe(e,"HH:mm",new Date)>i}return!0}),priority:de().oneOf(["low","medium","high"]).required("Priority is required"),date:Ft().required("Date is required").transform((e,r)=>r?pe(r,"yyyy-MM-dd",new Date):e),category:de().oneOf(["to-do","in-progress","done"]).required("Category is required")}),mt=({onClose:e,action:r,column:i,taskToEdit:t})=>{const{t:o}=ae();let a,n,s,d,u,h;typeof t=="object"&&t!==null&&({_id:a,title:n,start:s,end:d,priority:u,date:h}=t);const[p,v]=qt(),[c,f]=pt(),{currentDate:m}=Oe(),x=(R,T)=>{r==="add"&&p(R),r==="edit"&&c({id:a,...R}),T.resetForm(),e()},k=()=>{if(i==="To do")return"to-do";if(i==="In progress")return"in-progress";if(i==="Done")return"done"};return l.jsx(Ht,{initialValues:{title:r==="edit"&&n||"",start:r==="edit"&&s||"09:00",end:r==="edit"&&d||"10:00",priority:r==="edit"&&u||"low",date:r==="edit"&&h||m,category:k()},validationSchema:Cr,onSubmit:x,children:l.jsxs(gr,{children:[l.jsxs(De,{children:[o("Title"),l.jsx(mr,{type:"text",name:"title",placeholder:o("Enter text")}),l.jsx(Be,{name:"title",component:"div"})]}),l.jsxs(xr,{children:[l.jsxs(De,{children:[o("Start"),l.jsx(Je,{type:"time",name:"start"}),l.jsx(Be,{name:"start",component:"div"})]}),l.jsxs(De,{children:[o("End"),l.jsx(Je,{type:"time",name:"end"}),l.jsx(Be,{name:"end",component:"div"})]})]}),l.jsxs(br,{role:"group","aria-labelledby":"my-radio-group",children:[l.jsxs(se,{children:[l.jsx(ne,{type:"radio",name:"priority",value:"low"}),l.jsx(Ie,{value:"low"}),o("Low")]}),l.jsxs(se,{children:[l.jsx(ne,{type:"radio",name:"priority",value:"medium"}),l.jsx(Ie,{value:"medium"}),o("Medium")]}),l.jsxs(se,{children:[l.jsx(ne,{type:"radio",name:"priority",value:"high"}),l.jsx(Ie,{value:"high"}),o("High")]})]}),l.jsxs(yr,{children:[r==="add"?l.jsxs(Ke,{type:"submit",children:[l.jsx(Sr,{}),o("Add")]}):l.jsxs(Ke,{type:"submit",children:[l.jsx(Tr,{}),o("Edit")]}),l.jsx(wr,{type:"button",onClick:e,children:o("Cancel")})]}),l.jsx(Er,{type:"button","aria-label":"close button",onClick:e,children:l.jsx(kr,{})})]})})};mt.propTypes={onClose:b.func.isRequired,action:b.oneOf(["add","edit"]).isRequired,column:b.string.isRequired,taskToEdit:b.shape({_id:b.string,title:b.string,start:b.string,end:b.string,priority:b.string,date:b.string})};const Or=g.div`
  margin-bottom: 42px;
...
`;function jt({children:e}){return l.jsx(mi,{autoHide:!1,children:e})}jt.propTypes={children:b.any};const xi=g.ul`
  ...
  flex-direction: column;
  /* gap: 14px; */
`;function Mt({tasks:e,openModal:r}){return l.jsx(jt,{children:l.jsx(xi,{children:l.jsx(vt,{children:e&&e.map(i=>l.jsx(wt,{task:i,tasksCount:e.length,openModal:r},i._id))})})})}Mt.propTypes={tasks:b.array,openModal:b.func};const bi=g(ht.button)`
...
`;g.img`
  width: 24px;
  height: 24px;
`;function At({tasksCount:e,openModal:r}){const{t:i}=ae(),t=window.innerWidth;return l.jsxs(bi,{initial:{marginTop:0},animate:{marginTop:t>=768&&e?"32px":0},exit:{marginTop:0},transition:{duration:.1},count:e,onClick:()=>r(),children:[l.jsx(gt,{width:"24",height:"24"}),i("Add task")]})}At.propTypes={tasksCount:b.number,openModal:b.func};const yi=g.li`
  position: relative;
...
`,Ci=g.div`
  ...
  color: ${e=>e.selected?ft.white:e.theme.colors.textAndIconTodo};
...
`;function zt({date:e,tasks:r}){const{currentDate:i}=Oe(),{t}=ae(),[o,a]=w.useState(e),n=er();w.useEffect(()=>{a(i)},[i]);const s=window.innerWidth,d=sr(new Date(e),{weekStartsOn:1}),u=pr({start:d,end:lr(d,6)}),h=f=>s>=768?t(we(f,"eee")):t(`mob_${we(f,"eee")}`),p=f=>we(f,"yyyy-MM-dd"),v=f=>{const m=`/calendar/day/${p(f)}`;a(p(f)),n(m,{replace:!0})},c=f=>{const m=p(f),x=r.filter(T=>T.date===m),k=x.filter(T=>T.category!=="done"),R=x.filter(T=>T.category==="done");return l.jsx(l.Fragment,{children:k.length>0?l.jsx(Ri,{children:k.length}):k.length<1&&R.length>=1&&l.jsx(ji,{color:"#2ac76b",width:"15px",height:"15px"})})};return l.jsx(ki,{children:u.map(f=>l.jsx(Si,{children:l.jsxs("a",{onClick:()=>v(f),children:[l.jsx(Ti,{children:h(f)}),l.jsxs(Ci,{selected:p(f)===o,children:[c(f),l.jsx(Oi,{children:we(f,"d")})]})]})},f))})}zt.propTypes={date:b.string,tasks:b.array};const Mi=g.div`
  /* padding: 20px; */

  @media screen and (width >= 768px) {
    /* padding: 32px; */
  }
`;function Wi(){const e=tr(),{currentDate:r}=Oe(),i=or(pe(r,"yyyy-MM-dd",new Date)),t=nr(pe(r,"yyyy-MM-dd",new Date))+1,o={year:i,month:t},{data:a,isLoading:n,isFetching:s}=rr(o);return l.jsx(Mi,{children:!n&&!e&&a?l.jsxs(l.Fragment,{children:[l.jsx(zt,{date:r,tasks:a.tasks}),l.jsx(Nt,{tasks:a.tasks})]}):l.jsx(ir,{})})}export{Wi as default};
