import{a2 as C,au as M,s as o,t as e,N as W,ab as v,at as N,j as n,m as O,av as u,an as L,aw as A,ax as I,ao as f,ay as U,ap as h,az as F,aA as R,aB as B,u as E}from"./index-ba12659c.js";function b(t){return C(1,arguments),M(t,Date.now())}const H=t=>{switch(t.priority){case"low":return`color: ${e.colors.accent}; background-color: ${e.colors.blueInNotes};`;case"medium":return`color: ${e.colors.mediumTask}; background-color: ${e.colors.yellowInNotes};`;case"high":return`color: ${e.colors.highTask}; background-color: ${e.colors.pinkInNotes};`;default:return`color: ${e.colors.accent}; background-color: ${e.colors.white}`}},_=o.ul`
  border-radius: 8px;
  overflow: hidden;
  display: flex;
  flex-wrap: wrap;
